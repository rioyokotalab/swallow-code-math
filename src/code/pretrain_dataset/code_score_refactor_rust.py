...
3. Follow the rule of formatting tool like rustfmt.
...
7. Is the code free of unnecessary complexity, such as deeply nested structures or excessive use of global variables?
