...
#$ -l node_f=1
#$ -l h_rt=0:10:00:00
#$ -o outputs/llm-filter/self-contained/$JOB_ID.log
#$ -e outputs/llm-filter/self-contained/$JOB_ID.log
#$ -p -3
...
OUTPUT_DIR="/gs/bs/tga-NII-LLM/datasets/raw/pretrain/swallow-code-v0.3-jsonl-self-contained"
